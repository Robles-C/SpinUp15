...
class robotChasis{
  public:
    ...
    motor LeftRear = motor(PORT3, ratio18_1, true);
    motor RightFront = motor(PORT4, ratio18_1, false);
    motor RightMid = motor(PORT5, ratio18_1, true);
    motor RightRear = motor(PORT6, ratio18_1, false);
    motor intake1 = motor(PORT14, ratio18_1, true);
    motor intake2 = motor(PORT15, ratio18_1, true);
    motor fly1 = motor(PORT17, ratio6_1, true);
    motor fly2 = motor(PORT18, ratio6_1, false);



    // Declare Any pneumatics Here
    pneumatics midRange = pneumatics(Brain.ThreeWirePort.A);
    pneumatics closeRange = pneumatics(Brain.ThreeWirePort.E);
    pneumatics expan = pneumatics(Brain.ThreeWirePort.D);
    pneumatics mouth = pneumatics(Brain.ThreeWirePort.C);
    pneumatics loader = pneumatics(Brain.ThreeWirePort.B);
    ...
    rotation backTracker = rotation(PORT15, false);
